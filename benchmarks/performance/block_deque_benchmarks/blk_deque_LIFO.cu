...
// Kernel to perform LIFO Test on block level shared deque
__global__ void lifo_test_kernel(int* d_results) 
{
...
int main() 
{
    printf("--- Block-Level Shared Deque - LIFO ---\n");
    ...
    lifo_test_kernel<<<NUM_BLOCKS, THREADS_PER_BLOCK>>>(d_results);
