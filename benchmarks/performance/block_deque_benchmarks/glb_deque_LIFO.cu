...
// Kernel to perform LIFO Test
__global__ void lifo_test_kernel(GpuDeque<int>** all_deques, int* d_results) 
{
...
int main() 
{
    ...
    lifo_test_kernel<<<NUM_BLOCKS, THREADS_PER_BLOCK>>>(d_deque_array, d_results);
